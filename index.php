...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">FarmFresh &copy; </h3>
		<!--	<div class="logo">
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">FarmFresh Fam<span>Chennai</span></p>
		</div>
		<div>
	...
	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>About FarmFresh</b></span>
			FarmFresh is e-commerce trading platform for grains & grocerries...
		</p>
				...
				<center>
					...
					<div class="row uniform">
						...
						<div class="3u 12u$(small)">
							...
							<label for="signup_farmer">Farmer</label>
						</div>
						<div class="3u 12u$(small)">
